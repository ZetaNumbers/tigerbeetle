...
typedef enum TB_ACCOUNT_MUTABLE_FLAGS {
    TB_ACCOUNT_MUTABLE_LOCKED_CREDIT = 1 << 0,
} TB_ACCOUNT_MUTABLE_FLAGS;
...
typedef enum TB_TRANSFER_FLAGS {
    ...
    TB_TRANSFER_LOCK_CREDIT = 1 << 6,
    TB_TRANSFER_IGNORE_CREDIT_LOCK = 1 << 7,
} TB_TRANSFER_FLAGS;
...
typedef enum TB_CREATE_ACCOUNT_RESULT {
    ...
    TB_CREATE_ACCOUNT_RESERVED_MUTABLE_FLAG = 20,
...
typedef enum TB_CREATE_TRANSFER_RESULT {
    ...
    TB_CREATE_TRANSFER_CREDIT_ACCOUNT_LOCKED = 55,
    TB_CREATE_TRANSFER_CANNOT_LOCK_CREDIT_FOR_NON_PENDING_TRANSFER = 56,
